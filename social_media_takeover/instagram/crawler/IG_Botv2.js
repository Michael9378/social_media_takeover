...
function getPostPageInfo() {
		// TODO
		alert("getPostPageInfo() not implemented yet");
		return null;
}
...
function getTagPageInfo() {
		// TODO
		alert("getTagPageInfo() not implemented yet");
		return null;
}
...
function getUserPageInfo() {
    ...
    getUserNumFollowers(infoList);
    getUserNumFollowing(infoList);
...
function getUserFollowingInfo() {
    ...
    var followers = $(getElementsLikeLink("/followers/"));
    var following = $(getElementsLikeLink("/following/"));
    // following[0].click()
